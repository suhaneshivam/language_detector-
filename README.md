...
| French    | fra      | Il a ce qu'il faut pour réussir dans le monde     |
|           |          |    des affaires.                                  |
| Italian   | ita      | Non lo augurerei a nessuno.                       |
| Portuguese| por      | Cante-me uma canção de ninar.                     |
| Spanish   | spa      | El surgimiento del exoesqueleto en los artrópodos |
|           |          | fue un acontecimiento evolutivo muy               |
|           |          | importante para esos animales                     | 
